    ...
    <div class="row " style="padding:none !important; margin:none !important;">
        <div class="col-8  blacked borderleft">
            <div class="q-pt-xl text-primary text-h4 q-pl-xl text-weight-bolder ">Architectural <span
                    class="text-italic">Combinational Studio</span> </div>
            <div class="q-pt-xl">
            </div>
            <div class="q-pt-md">
            </div>
        ...
        <div class="col-4 darked" style="height: 99.8vh;">
            <div class="q-pa-md">
                ...
                <div class="text-center text-bold text-h6 text-white">{{ day }}, {{ month.slice(0, 3) }} {{ date }}
                </div>
            </div>
            <div class="q-pt-md">
...
export default {
    ...
    setup(props) {
        ...
        return { upComing, currentSche, createTime }
    }
}
</script>
